...
int main(int argc, char** argv)
{
	...
	if (test_choise[T_POINT] == '1') {
		...
		/* 50个粗细为3的点 */
		hdc_set_pencolor(255, 0, 0);//红2
		for (i = 0; i < 50; i++)
			hdc_point(100 + i * 10, 100, 3);

		/* 50个粗细为5的点 */
		for (i = 0; i < 50; i++)
			hdc_point(100, 150 + 10 * i, 5, RGB(0, 255, 0)); //绿12

		/* 20个粗细为10的点 */
		for (i = 0; i < 20; i++)
			hdc_point(120 + 25 * i, 120 + 25 * i, 10, RGB(0, 0, 255)); //蓝82
	...
	if (test_choise[T_MATHCURVE] == '1') {
		...
		hdc_draw_Mathematical_curve_1852877();
		to_be_continued("数学曲线-我-完成", STL_X, STL_Y);
	}
	...
	if (test_choise[T_CUSTOM] == '1') {
		...
		hdc_draw_catoon_1852877(400, 400);
		to_be_continued("我-完成", STL_X, STL_Y);
